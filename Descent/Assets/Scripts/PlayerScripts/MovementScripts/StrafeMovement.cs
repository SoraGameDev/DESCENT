...
public class StrafeMovement : MonoBehaviour
{
    ...
    [Header("ALWAYS KEEP ON ENVIRONMENT")]
    [SerializeField]
    private LayerMask groundLayers;     // What the player can bhop on
    ...
    /// <summary>
    /// Inefficient way to do this currently but it works for now.
    /// </summary>
